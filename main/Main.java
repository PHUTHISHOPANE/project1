...
public class Main extends javax.swing.JFrame {
    ...
    public int messageRecipient = 444;
    ...
    private void open() {
        ...
        Method.setTextFieldSyle(recipientName, "Chat with...");
    ...
    private void initComponents() {
        ...
        recipientID2 = new javax.swing.JLabel();
        ...
        recipientName.setFont(new java.awt.Font("Segoe UI Semibold", 0, 14)); // NOI18N
        recipientName.setText("Chat with...");
        recipientName.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                recipientNameFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                recipientNameFocusLost(evt);
            }
        });
            ...
            .addGroup(panel_bgLayout.createSequentialGroup()
                ...
                .addGroup(panel_bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_bgLayout.createSequentialGroup()
                        ...
                        .addGap(161, 161, 161)
                        .addComponent(lbStatus, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
                        .addGap(19, 19, 19))
                    .addGroup(panel_bgLayout.createSequentialGroup()
                        .addComponent(recipientID2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panel_bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_bgLayout.createSequentialGroup()
                                .addComponent(txt)
                            ...
                            .addComponent(spChat, javax.swing.GroupLayout.DEFAULT_SIZE, 621, Short.MAX_VALUE))))
                .addContainerGap())
        );
        panel_bgLayout.setVerticalGroup(
            ...
            .addGroup(panel_bgLayout.createSequentialGroup()
                ...
                .addGroup(panel_bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(spChat, javax.swing.GroupLayout.PREFERRED_SIZE, 395, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(panel_bgLayout.createSequentialGroup()
                        .addComponent(spFriend, javax.swing.GroupLayout.PREFERRED_SIZE, 343, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(recipientName, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmdMore, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                    ...
                    .addComponent(txt)
                    .addComponent(recipientID2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
...
;
                ...
                try {
                    while (true) {
                        ...
                        if (status.equals("Message++")){
                            getMessage(ms.getID(), ms.getMessage().substring(ms.getMessage().indexOf(";") + 1));
                        }
                        if (status.equals("Message")) {
    ...
    private void cmdSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSendActionPerformed
        ...
        if (txt.getName().equals("have") && !txt.getText().equals("")) {
            try {
                ...
                if (recipient.equals("Chat with...")){
                    recipient = "";
                }
                
                System.out.println("user: "+ recipient);

                Method.sendMessage(txt.getText().trim(), recipient);
                txt.setText("");
                txt.grabFocus();
            } catch (Exception e) {
            }
    ...
    public void setMessageRecipient(int rcp){
    ...
    private void recipientNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_recipientNameFocusLost
        
    }//GEN-LAST:event_recipientNameFocusLost

    private void txtFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtFocusGained
        
    }//GEN-LAST:event_txtFocusGained

    private void recipientNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_recipientNameFocusGained
        
    }//GEN-LAST:event_recipientNameFocusGained

    private void recipientNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_recipientNameKeyReleased
        if(evt.getKeyCode() == evt.VK_ENTER) {
            bubble alert = new bubble();
            
            alert.setMessage("You are now in private chat with "+recipientName.getText());
    ...
    private javax.swing.JLabel recipientID2;
